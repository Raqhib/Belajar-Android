package id.co.mondo.mybroadcastreceiver
...
import id.co.mondo.mybroadcastreceiver.databinding.ActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        downloadReceiver = object : BroadcastReceiver(){
            override fun onReceive(context: Context, intent: Intent) {
                Toast.makeText(context, "Dowload Selesai", Toast.LENGTH_SHORT).show()
            }
        }
