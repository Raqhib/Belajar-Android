...
public final class EfficientdetLite0V1 {
  @NonNull
  ...
  private EfficientdetLite0V1(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "efficientdet_lite0_v1.tflite", options);
  ...
  @NonNull
  public static EfficientdetLite0V1 newInstance(@NonNull Context context) throws IOException {
    return new EfficientdetLite0V1(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static EfficientdetLite0V1 newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new EfficientdetLite0V1(context, options);
  }
