package id.co.mondo.ticketingapps
...
class SeatsView: View {
    ...
    private val backgorundPaint = Paint()
    ...
    private fun drawSeat(canvas: Canvas?, seat: Seat){
        ...
        if(seat.isBooked){
            backgorundPaint.color = ResourcesCompat.getColor(resources, R.color.grey_200, null)
            ...
            backgorundPaint.color = ResourcesCompat.getColor(resources, R.color.blue_500, null)
        ...
        canvas?.drawPath(backgroundPath, backgorundPaint)
